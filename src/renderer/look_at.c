...
/*   Updated: 2020/02/24 19:35:49 by abe              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vec3f	look_at(t_camera *cam, t_vec3f ray_origin)
{
	...
	return (vec_new(
		right.x * ray_origin.x + right.y * ray_origin.y +
			right.z * ray_origin.z,
		up.x * ray_origin.x + up.y * ray_origin.y + up.z * ray_origin.z,
		forward.x * ray_origin.x + forward.y * ray_origin.y +
			forward.z * ray_origin.z));
}
